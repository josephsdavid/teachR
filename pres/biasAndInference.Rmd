...
rf_explained <- explain_mlr(model_rf, 
  ...
  y = wineTest$quality,
  label = "rf")
explainers <- list(rf_explained, knn_explained, rf_explained)
```

## Model Performance: residuals

```{r}
perfs <- lapply(explainers, model_performance)
p1 <- plot(model_perfs[[1]], model_perfs[[2]], model_perfs[[3]])
p2 <- plot(model_perfs[[1]], model_perfs[[2]], model_perfs[[3]], geom = "boxplot")
```
...
>- [DrWhy.AI, START HERE FOR EXPLAINABLE AI](https://github.com/ModelOriented/DrWhy)
